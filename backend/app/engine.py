        ...
        *,
        ...
        for source in locations:
            for target in locations:
                ...
                matrix[(source, target)] = result.total_cost if result.found and result.total_cost is not None else math.inf
        ...
        for source, target in itertools.pairwise(visit_sequence):
